...
export default function Home() {
  ...
  const [showModal, setShowModal] = useState<"manga" | "panel" | null>(null);
          ...
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-lg">
              ...
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-base font-semibold text-gray-800">Add panel</h2>
                <button
                  onClick={() => { setShowModal(null); setChapter(""); setPanelImage(""); }}
              ...
              <div className="flex gap-3 mb-4">
                <input
                  type="file"
                  accept="image/*"
                  onChange={handlePanelImageChange}
                  ref={panelInputRef}
                  className="hidden"
                />
                <div
                ...
                >
                  {panelImage ? (
                    <img src={panelImage} alt="Cover" className="w-full h-full object-cover" />
                  ) : (
                    <span className="text-gray-300 text-xs text-center leading-tight">Panel</span>
                  )}
                </div>
                ...
                <div className="flex flex-col justify-center flex-1">
                  ...
                  />
                  <p className="text-xs text-gray-300 mt-2">Panel is mandatory.</p>
                </div>
              </div>
          ...
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-lg">
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <button
                  onClick={() => { setShowModal(null); setMangaTitle(""); setMangaCover(""); }}
                  className="text-gray-300 hover:text-gray-500 text-xl leading-none"
                >
                  ×
                </button>
